...
<p>如果您无法确定这些问题，请联系您的主机管理员。如果您仍需帮助，请访问<a href=\'http://wordpress.org/support/\'>WordPress支持论坛</a>。</p>
...
<p如果您不知道如何设置一个数据库，您应该<strong>联系您的主机管理员</strong>。如果所有办法还没有解决您的问题，您可以在<a href="http://wordpress.org/support/">WordPress支持论坛</a>上寻求帮助。</p>'/*/WP_I18N_DB_SELECT_DB*/, $db, DB_USER));
			return;
		}
	}
	...
	function print_error($str = '') {
		...
		if ( $caller = $this->get_caller() )
			$error_str = sprintf(/*WP_I18N_DB_QUERY_ERROR_FULL*/'WordPress 数据库错误 %1$s 查询 %2$s %3$s 调用'/*/WP_I18N_DB_QUERY_ERROR_FULL*/, $str, $this->last_query, $caller);
		else
			$error_str = sprintf(/*WP_I18N_DB_QUERY_ERROR*/'WordPress 数据库错误 %1$s 查询 %2$s'/*/WP_I18N_DB_QUERY_ERROR*/, $str, $this->last_query);

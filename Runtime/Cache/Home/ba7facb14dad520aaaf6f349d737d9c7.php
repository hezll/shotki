...
<title><?php echo ($keyword); ?>-<?php echo ($sitename); ?></title>
<meta name="keywords" content="<?php echo ($keyword); ?>-<?php echo ($sitename); ?>" />
<meta name="description" content="<?php echo ($keyword); ?>-<?php echo ($sitename); ?>" />
...
<?php if(is_array($cidarr)): $i = 0; $__LIST__ = $cidarr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ppcid): ++$i;$mod = ($i % 2 )?>&nbsp;| <a href="<?php echo getlistname($ppcid,'list_url');?>"><?php echo getlistname($ppcid);?></a><?php endforeach; endif; else: echo "" ;endif; ?>
 &nbsp;| <a href="<?php echo getlistname($ppcid,'list_url');?>">排行榜</a></div>
  ...
  <div class="topInfo2">
    <div id="topInfo2" class="topInfo2"><div class="topInfoC"><a href="<?php echo ($root); ?>index.php?s=gb.html" target="_blank" class="fankuikou">在线留言</a> </div> 您现在的位置：<span  id="navbar"><a href="<?php echo ($root); ?>">首页</a>&nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;搜索 <?php echo ($keyword); ?> 的结果</span> </div>
  </div>
 <div class="mBg4">
    <div class="m250">
	      <dl class="fllbDl">
...
<a href="index.php?s=vod-search-x-area-id-%E5%85%B6%E5%AE%83">未知</a>
      ...
      <div id="paixu" class="paixu">
        ...
        <strong><?php echo ($keyword); ?>列表</strong> </div>
      <div style="display: block;" id="c1">
        <ul id="j-search-poster" class="ulList r4">
<?php $list=$pplist->ppvod('pid:'.$list_id.';num:16;page:true;action:search');$page=$list[0]
['page']; ?>
